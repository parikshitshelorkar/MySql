...
INSERT INTO cart_items (cart_id, product_id, quantity, ItemImage)
VALUES  (2, 4, 3, '/images/Fashion/necklace.jpeg'); -- necklace
...
(8, 'Shipped', '2025-07-26'),
(9, 'Shipped', '2025-07-27'),
(10, 'Delivered', '2025-07-28'),
(11, 'Processing', '2025-07-28'),
(12, 'Cancelled', '2025-07-29'),
(13, 'Shipped', '2025-07-30');
...
(8, '2025-08-04 15:00:00', 'Pending', NULL, NULL, 'Awaiting packing.'),
(9, '2025-08-05 16:00:00', 'Shipped', 'TRACK123459', 'UPS', 'Shipped and on its way.'),
(10, '2025-08-06 17:00:00', 'Packed', 'TRACK123460', 'FedEx', 'Packed and awaiting pickup.'),
(11, '2025-08-07 18:00:00', 'Delivered', 'TRACK123461', 'DHL', 'Delivered successfully.'),
(12, '2025-08-08 19:00:00', 'Shipped', 'TRACK123462', 'UPS', 'Shipped with UPS.'),
(13, '2025-08-09 20:00:00', 'Pending', NULL, NULL, 'Packing in progress.'),
(13, '2025-08-10 21:00:00', 'Shipped', 'TRACK123463', 'FedEx', 'Shipped via FedEx.');


-- insert into payments
INSERT INTO payments (order_id, payment_amount, payment_method, payment_status) VALUES
(8, 529.98, 'Bank Transfer', 'Pending'), -- Payment for order 1
(9, 179.98, 'Credit Card', 'Failed'), -- Payment for order 2
(10, 179.98, 'PayPal', 'Completed'), -- Payment for order 3
(11, 99.98, 'Debit Card', 'Completed'), -- Payment for order 4
(12, 499.98, 'Credit Card', 'Pending'), -- Payment for order 5
(13, 449.98, 'Bank Transfer', 'Completed'), -- Payment for order 6
(14, 389.98, 'PayPal', 'Failed'); -- Payment for order 7
...
(8, 'SUMMER21'),     -- Assuming order_id 1 used SUMMER21 discount
(9, 'WINTER21'),     -- Assuming order_id 2 used WINTER21 discount
(10, 'DIWALI21'),     -- Assuming order_id 3 used DIWALI21 discount
(11, 'HOLI21'),       -- Assuming order_id 4 used HOLI21 discount
(12, 'NEWYEAR21'),    -- Assuming order_id 5 used NEWYEAR21 discount
(13, 'INDEPENDENCE21'), -- Assuming order_id 6 used INDEPENDENCE21 discount
(13, 'REPUBLIC21');   -- Assuming order_id 7 used REPUBLIC21 discount
...
(8, 7, 8), -- 8 pink rose
(9, 13, 1), -- 1 t shirt
(9, 16, 1), -- 11 smart watch
(10, 19, 1), -- 10 iphone
(10, 4, 5), -- 5 high heels
(11, 23, 6), -- 6 lenovo laptop
(11, 29, 7), -- 7 Shampoo
(12, 16, 1), -- 1 smart watch
(12, 15, 5), -- 5 girls watch
(13, 39, 1), -- 1 sunflower oil
(13, 33, 4); -- 4 lipsticks
...
(8, 1, '2025-07-25', 'TRACK001', 'Shipped'),
(9, 2, '2025-07-26', 'TRACK002', 'Shipped'),
(10, 3, '2025-07-27', 'TRACK003', 'Delivered'),
(11, 4, '2025-07-28', 'TRACK004', 'Pending'), -- Changed 'Processing' to 'Pending'
(12, 5, '2025-07-29', 'TRACK005', 'Failed'),   -- Changed 'Cancelled' to 'Failed'
(13, 6, '2025-07-30', 'TRACK006', 'Shipped'),
(13, 7, '2025-07-31', 'TRACK007', 'Delivered');
...
(8, 1, 'Defective item', '2024-07-27', 'Pending'),  -- Return for Smartphone in Order 1
(9, 3, 'Incorrect item received', '2024-07-28', 'Pending'),  -- Return for Fiction Novel in Order 2
(10, 5, 'Product not as described', '2024-07-29', 'Pending'),  -- Return for Smartwatch in Order 3
(11, 6, 'Wrong item received', '2024-07-30', 'Pending'),  -- Return for Tablet in Order 4
(12, 8, 'Changed mind', '2024-07-31', 'Pending'),  -- Return for Shirt in Order 5
(13, 10, 'Defective item', '2024-08-01', 'Pending'),  -- Return for Bluetooth Speaker in Order 6
(13, 10, 'Product not as described', '2024-08-02', 'Pending'); -- Return for Bluetooth Speaker in Order 7
...
(8, 1, 250, '2025-08-01 10:00:00'), -- crocs
(9, 2, 590, '2025-08-02 11:00:00'), -- hign heels
(10, 3, 450, '2025-08-03 09:00:00'),   -- sneaker
(11, 4, 199, '2025-08-04 10:00:00'),   -- necklace
(12, 5, 20, '2025-08-05 14:00:00');  -- pink rose
