-- drop database TFLShoppingEcommerce;

Create DATABASE TFLShoppingEcommerce;
USE TFLShoppingEcommerce;
...
CREATE TABLE inventory (
    ...
    product_id INT ,
    stock_quantity INT,
    CONSTRAINT fk_product_id FOREIGN KEY (product_id) REFERENCES categoryproduct(id)
        ON UPDATE CASCADE
        ON DELETE CASCADE
);
...
CREATE TABLE order_items (
    ...
    FOREIGN KEY (order_id) REFERENCES orders(id)
        ON UPDATE CASCADE
        ON DELETE CASCADE,
    FOREIGN KEY (item_id) REFERENCES categoryproduct(id)
        ON UPDATE CASCADE
        ON DELETE CASCADE
);
